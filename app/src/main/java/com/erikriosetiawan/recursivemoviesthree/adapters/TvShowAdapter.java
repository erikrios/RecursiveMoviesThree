...
import com.erikriosetiawan.recursivemoviesthree.DetailsActivity;
...
public class TvShowAdapter extends RecyclerView.Adapter<TvShowAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            btnTvShowVoteCount = itemView.findViewById(R.id.btn_list_vote_count_tv_shows);
            btnTvShowVoteAverage = itemView.findViewById(R.id.btn_list_vote_average_tv_shows);
